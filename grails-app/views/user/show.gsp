            ...
            <div class="h-full pb-16 overflow-y-auto">
                <div class="container px-6 mx-auto grid">
                    ...
                    <div class="grid gap-6 mb-8 md:grid-cols-2">
                        <g:form resource="${this.user}" action="edit">
                            <div class="">
                                <g:link  action="edit" resource="${this.user}"><button class="px-10 py-4 font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple" >Edit</button></g:link>
                            </div>
                        </g:form>
                        <g:form resource="${this.user}" method="DELETE">
                            <g:if test="${(user.id).toString().equals(sec.loggedInUserInfo(field: 'id').toString())}">
                                <div class="">
                                    <button class="px-10 py-4 font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg opacity-50 cursor-not-allowed focus:outline-none"  type="submit" value="${message(code: 'default.button.delete.label', default: 'Delete')}"  >Delete</button>
                                </div>
                            </g:if>
                            <g:else>
                                <div class="">
