            ...
            <ul class="mt-6">
              ...
              ></span> -->
                    ...
                    >
                        ...
                        <span class="ml-4">Sweet Hone</span>
                    </a>
                </li>
            </ul>
            <ul>
                ...
                <li class="relative px-6 py-3">
                    ...
                    >
                        ...
                        <span class="ml-4">Add annonce</span>
                    </a>
                </li>
                <li class="relative px-6 py-3">
                    <a
                ...
                <li class="relative px-6 py-3">
                    ...
                    >
                        ...
                        <span class="ml-4">Illustrations</span>
                    </a>
                </li> -->
                <li class="relative px-6 py-3">
                    <a
                    ...
                    >
                        ...
                        <span class="ml-4">Not logged in ?</span>
                    </a>
                </li>
            ...
            >
                ...
                <div class="flex justify-center flex-1 lg:mr-32">
                    ...
                    >
                        ...
                        <form action="/annonce/index/" method="get">
                            <input
                    ...
                    <li class="relative">
                        ...
                        <template x-if="isProfileMenuOpen">
                            ...
                            <sec:ifLoggedIn>
                                ...
                                <li class="flex">
                                    <g:link controller="logout"  class="inline-flex items-center w-full px-2 py-1 text-sm font-semibold transition-colors duration-150 rounded-md hover:bg-gray-100 hover:text-gray-800 dark:hover:bg-gray-800 dark:hover:text-gray-200"   >
                                            <svg
                                                    class="w-4 h-4 mr-3"
                                                    aria-hidden="true"
                                                    fill="none"
